...
save.image(file = here("Outputs", "CACPR Cluster Defining DEGs.RData"))

allobj <- ls()
alldf <- sapply(allobj, get, simplify = FALSE)
alldf <- alldf[sapply(alldf, inherits, "data.frame")]

write.xlsx(alldf, sheetName = names(alldf), file = here("Outputs", "CACPR Cluster Defining DEGs.xlsx"))
...
save.image(file = here("Outputs", "IRI Cluster Defining DEGs.RData"))

allobj <- ls()
alldf <- sapply(allobj, get, simplify = FALSE)
alldf <- alldf[sapply(alldf, inherits, "data.frame")]

write.xlsx(alldf, sheetName = names(alldf), file = here("Outputs", "IRI Cluster Defining DEGs.xlsx"))
