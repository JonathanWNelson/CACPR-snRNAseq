---
title: "CACPR Ambient RNA and Doublet Removal"
...
tod = Seurat::Read10X(here("GEO", "Cell Ranger", "CACPR", "raw_feature_bc_matrix")) #Change
toc = Seurat::Read10X(here("GEO", "Cell Ranger", "CACPR", "filtered_feature_bc_matrix")) #Change 
sc = SoupChannel(tod,toc)

#Make the Seurat object from the filtered control data
SO <- Seurat::Read10X(here("GEO", "Cell Ranger", "CACPR", "filtered_feature_bc_matrix")) #Change
SO <- CreateSeuratObject(counts = SO, project = "CACPR")  #Change
...
nExp_poi <- round(0.056*nrow(seurat.obj.f@meta.data)) #Change
nExp_poi
...
seurat.obj.f_singlets <- AddMetaData(object = seurat.obj.f_singlets, metadata = "CACPR", col.name = "Condition") #Change
...
saveRDS(seurat.obj.f_singlets, here("Outputs", "CACPR.rds")) #Change
```
